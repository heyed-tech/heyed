...
function ScreenshotScrollSection() {
  ...
  const image1Scale = useTransform(scrollYProgress, [0, 0.15, 0.2], [1, 1, 0.98])
  
  const image2Opacity = useTransform(scrollYProgress, [0.15, 0.2, 0.3, 0.35], [0, 1, 1, 0])
  const image2Scale = useTransform(scrollYProgress, [0.15, 0.2, 0.3, 0.35], [0.98, 1, 1, 0.98])
  
  const image3Opacity = useTransform(scrollYProgress, [0.3, 0.35, 0.5], [0, 1, 1])
  const image3Scale = useTransform(scrollYProgress, [0.3, 0.35, 0.5], [0.98, 1, 1])
  ...
  const text3Opacity = useTransform(scrollYProgress, [0.3, 0.35, 0.5], [0, 1, 1])
